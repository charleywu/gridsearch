...
psych::cohen.d.ci(cohensD(subset(aggregatedByIndividuals, scenario=="Avg. Reward Condition")$meanDelta_x, subset(aggregatedByIndividuals, scenario=="Max. Reward Condition")$meanDelta_x), n1 =41, n2 = 39) 
...
psych::cohen.d.ci(cohensD(subset(dm, scenario=="Avg. Reward Condition")$mu, subset(dm, scenario=="Max. Reward Condition")$mu), n1 = 41, n2 = 39)
...
psych::cohen.d.ci(cohensD(subset(dm, kernel=="Smooth")$mu, subset(dm, kernel=="Rough")$mu),n1 = 43, n2 = 37) 
...
psych::cohen.d.ci(cohensD(subset(dm, horizon==20)$mu, subset(dm, horizon==40)$mu), n1 = 80)
